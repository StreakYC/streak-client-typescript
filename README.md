...
[![NPM version](<https://img.shields.io/npm/v/streak-client-typescript.svg?label=npm%20(stable)>)](https://npmjs.org/package/streak-client-typescript) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/streak-client-typescript) [![JSR Version](https://jsr.io/badges/@streak-api/streak)](https://jsr.io/@streak-api/streak)
...
```sh
npm install streak-client-typescript
```
