...
[![NPM version](<https://img.shields.io/npm/v/streak.svg?label=npm%20(stable)>)](https://npmjs.org/package/streak) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/streak)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/streak-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install streak`
...
1. Via the `STREAK_LOG` environment variable
...
const client = new Streak({
  logger: logger.child({ name: 'Streak' }),
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/streak-typescript/issues) with questions, bugs, or suggestions.
