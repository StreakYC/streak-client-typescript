...
[![NPM version](<https://img.shields.io/npm/v/streak-client.svg?label=npm%20(stable)>)](https://npmjs.org/package/streak-client) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/streak-client)
...
```ts
import Streak from 'npm:streak-client';
